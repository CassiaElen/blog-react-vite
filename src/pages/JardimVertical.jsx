...
import jarverti2 from '../img/jardimVertical2.jpg';
function JardimVertical(){
    return(
        <>
        <Header />
       <main>
           <section className="section">
               <div style={{
                   ...
                   <div style={{
                       ...
                       <img src={jarverti2} alt="" style={{ width: '100%', borderRadius:20, margin:20 }} />
                       ...
                       <img src={jarverti} alt="" style={{ width: '100%' , borderRadius:20, margin:20 }} />
