...
import plantaesta2 from '../img/plantaestacao2.jpg';
function PlantaEstacao(){
    return(
        <>
        <Header />
       <main>
           <section className="section">
               <div style={{
                   ...
                   <div style={{
                       ...
                       <HeaderaSection titulo="Jardim Vertical"/>
                       ...
                       <img src={plantaesta1} alt="" style={{ width: '100%', borderRadius:20, margin:20 }} />
                       ...
                       <img src={plantaesta2} alt="" style={{ width: '100%' , borderRadius:20, margin:20 }} />
