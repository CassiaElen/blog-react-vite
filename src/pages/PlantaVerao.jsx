...
import plantaverao2 from '../img/plantaverao2.jpg';
function PlantaVerao(){
    return(
        <>
        <Header />
       <main>
           <section className="section">
               <div style={{
                   ...
                   <div style={{
                       ...
                       <img src={plantaverao1} alt="" style={{ width: '100%', borderRadius:20, margin:20 }} />
                       ...
                       <img src={plantaverao2} alt="" style={{ width: '100%' , borderRadius:20, margin:20 }} />
