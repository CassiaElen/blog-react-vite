...
import imginver from '../img/jardimdesonhos1.jpg';
import inverno from '../img/imginverno1.jpg';
import imginver2 from '../img/jardimdesonhos2.jpg';
function JardimSonhos() {
    return (
        <>
            <Header />
            <main>
                <section className="section">
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <HeaderaSection titulo="Jardim de Sonhos" />
                        ...
                        <div style={{
                            ...
                            <Link style={{ marginBottom: 80 }} to={'/jardiminverno'}>
                                <ImgCard altura={200} largura={300} imagem={inverno} descricao="Dica de cultivo" titulo="Cultive Conhecimento" />
                            </Link>
