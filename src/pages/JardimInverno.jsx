...
import imginver3 from '../img/jardimdesonhos2.jpg';
import imginver2 from '../img/imginverno2.jpg';
function JardimInverno(){
    return(
        <>
                   <Header />
            <main>
                <section className="section">
                    <div style={{
                        ...
                        <div style={{
                            ...
                            <HeaderaSection titulo="Jardim de Inverno"/>
                            ...
                            <img src={imginver2} alt="" style={{ width: '100%', borderRadius:20, margin:20 }} />
                        ...
                        <Link style={{marginBottom:80}} to={'/jardimsonhos'}>
                            <ImgCard altura={200} largura={300} imagem={imginver3} descricao="Dica de cultivo" titulo="Jardim de sonhos" />
                        </Link>
                        <Link style={{marginBottom:80}} to={'/jardiminverno'}>
                            <ImgCard altura={200} largura={300} imagem={imginver} descricao="Dica de cultivo" titulo="Jardim de inverno" />
                        </Link>
